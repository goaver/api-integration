...
- <b>fileContent (optional)</b> - Base64 image (JPG or PNG) Data URL containing the individual's face.  When provided, this will perform Visual Watchlist search in addition to the Text Watchlist search (associated fees apply).
